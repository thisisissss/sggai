  ...
  <div class="wrap foot">
    <div class="foot-main">
      ...
      <div class="social-links">
        ...
        <a href="https://facebook.com/profile.php?id=61556530944739" target="_blank" rel="noopener" class="social-icon" title="Facebook">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        </a>
        <a href="https://instagram.com/sustainablegreengold" target="_blank" rel="noopener" class="social-icon" title="Instagram">
        ...
        <a href="https://twl.ae/sustainablegreengold" target="_blank" rel="noopener" class="social-icon" title="Tawasal">
        ...
        <a href="https://www.tiktok.com/@digital.farm.cr" target="_blank" rel="noopener" class="social-icon" title="TikTok">
    ...
    <div class="foot-map">
      <div class="foot-map-label">{t.footer.maptitle}</div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        on:click={() => track("directions_click", { location: "install_footer" })}
      >
        {t.footer.directions} →
      </a>
    </div>
...
<style>
  ...
  .foot { display: grid; grid-template-columns: 1fr; gap: 2.75rem; align-items: center; }
  .foot-main { display: flex; flex-direction: column; align-items: center; gap: 1.5rem; text-align: center; }
  ...
  /* ── FOOTER MAP ── */
  .foot-map { width: 100%; max-width: 460px; margin: 0 auto; }
  .foot-map-label { font-family: "IBM Plex Mono", monospace; font-size: 0.68rem; letter-spacing: 0.14em; text-transform: uppercase; color: rgba(123,227,164,0.6); margin-bottom: 0.75rem; }
  .foot-map-frame { position: relative; aspect-ratio: 16 / 10; border-radius: 6px; overflow: hidden; border: 1px solid rgba(255,255,255,0.12); }
  .foot-map-frame iframe {
    width: 100%;
    height: 100%;
    border: 0;
    display: block;
    /* Fakes a dark map to sit against #081713. Delete this line to fall back
       to Google's standard light map. */
    filter: invert(92%) hue-rotate(180deg) contrast(0.86) saturate(0.75);
  }
  .foot-dir { font-family: "Bebas Neue", "Manrope", sans-serif; display: inline-block; margin-top: 0.9rem; color: rgba(255,255,255,0.55); text-decoration: none; font-size: 1rem; letter-spacing: 0.08em; text-transform: uppercase; transition: color 0.15s; }
  ...
  @media (min-width: 901px) {
    .foot { grid-template-columns: 1fr auto; gap: 4rem; }
    .foot-main { align-items: flex-start; text-align: left; }
    .foot-links { justify-content: flex-start; }
    .foot-map { margin: 0; width: 380px; }
  }
